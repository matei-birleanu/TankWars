...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1, 0, 1), glm::vec3(1, 0, 1)),
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(1, 0, 1), glm::vec3(1, 0, 1)),
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(1, 0, 1), glm::vec3(1, 0, 1)),
            VertexFormat(glm::vec3(1, 1,  0), glm::vec3(1, 0, 1), glm::vec3(1, 0, 1))
        };
    ...
    // by definition!
    {
        vector<VertexFormat> vertices = {
            ...
            VertexFormat(glm::vec3(0.5, 1,  0.5), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
        };
        ...
        meshes["tethra"] = new Mesh("made tethra");
        meshes["tethra"]->InitFromData(vertices, indices);

        CreateMesh("tethra", vertices, indices);
    }
...

    {
        vector<VertexFormat> vertices = {
            ...
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
        };
        ...
        meshes["square"] = new Mesh("made square");
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_A"], shaders["VertexNormal"], glm::vec3(-1.5f, 0.5f, 0), glm::vec3(0.25f));
    ...
    RenderMesh(meshes["tethra"], shaders["VertexColor"], glm::vec3(3.5f, 2.5f, 0), glm::vec3(1.0f));

    // TODO(student): Draw the square

    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(-2.0f, 0, 1), glm::vec3(1.0f));
